...
func (*TuningStateRequest) Descriptor() ([]byte, []int) {
	return file_tuningstate_proto_rawDescGZIP(), []int{1}
}
...
func (x *TuningState_Parameter_StringParameter) Reset() {
	*x = TuningState_Parameter_StringParameter{}
	if protoimpl.UnsafeEnabled {
		mi := &file_tuningstate_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_tuningstate_proto_rawDesc = []byte{
	...
	0x22, 0x32, 0x0a, 0x12, 0x54, 0x75, 0x6e, 0x69, 0x6e, 0x67, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52,
	...
	0x74, 0x61, 0x6d, 0x70, 0x42, 0x13, 0x5a, 0x11, 0x61, 0x73, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74,
...
var file_tuningstate_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
...
func file_tuningstate_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_tuningstate_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_tuningstate_proto_msgTypes[2].OneofWrappers = []interface{}{
